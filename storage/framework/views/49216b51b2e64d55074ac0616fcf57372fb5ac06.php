...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a class="brand-link">
      <span class="brand-text font-weight-light"><b>Pengaduan</b></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="info">
          <a class="d-block"><?php echo e(Auth::user()->nama); ?></a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <li class="nav-item">
            <a href="/masyarakat-dashboard" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/masyarakat-create-aduan" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/masyarakat-profile" class="nav-link">
...
<?php /**PATH C:\xampp\htdocs\pengaduan\resources\views/template/masyarakat.blade.php ENDPATH**/ ?>