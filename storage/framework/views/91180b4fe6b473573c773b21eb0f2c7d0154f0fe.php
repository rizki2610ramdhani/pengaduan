    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/admin-daftar-petugas" class="nav-link">
          ...
          <li class="nav-item">
            <a href="/admin-daftar-masyarakat" class="nav-link">
              <i class="nav-icon fas fa-edit"></i>
              <p>
                Daftar Masyarakat
              </p>
...
<?php /**PATH C:\xampp\htdocs\pengaduan\resources\views/template/admin.blade.php ENDPATH**/ ?>